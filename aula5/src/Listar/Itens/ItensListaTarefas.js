...
import ConcluirTarefa from '../Concluir/ConcluirTarefa';
import RemoverTarefa from '../Remover/RemoverTarefa'
    ...
    return (
        props.tarefas.map(tarefa => 
            <tr key={tarefa.id} data-testid="tarefa">
                <td width="75%" data-testid="nome-tarefa" style={{ textDecoration: marcarConcluida(tarefa) }}>
                    {tarefa.nome}
                </td>
